...
using MyCafeShop.DAO.BillInfoDao;
using MyCafeShop.DAO.CategoryDao;
using MyCafeShop.DAO.FoodDao;
using MyCafeShop.DAO.TableFoodDao;
using MyCafeShop.Views;
...
namespace MyCafeShop.ViewModels.AdminScreen {
